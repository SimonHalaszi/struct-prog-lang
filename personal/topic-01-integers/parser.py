...
def test_parse_term():
    ...
    tokens = tokenize("9/4")
    ast, tokens = parse_term(tokens)
    assert ast == {'tag': '/', 'left': {'tag': 'number', 'value': 9}, 'right': {'tag': 'number', 'value': 4}}

    tokens = tokenize("1/7*3")
    ast, tokens = parse_term(tokens)
    assert ast == {'tag': '*', 'left': {'tag': '/', 'left': {'tag': 'number', 'value': 1}, 'right': {'tag': 'number', 'value': 7}}, 'right': {'tag': 'number', 'value': 3}}
